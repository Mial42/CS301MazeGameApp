...
public interface Robot {
	...
	///////////////////////////////////////////////////////////////////
	/**
	 * Provides the robot with a reference to the PlayingActivity to cooperate with.
	 * The robot memorizes the PlayingActivity such that this method is most likely called only once
	 * and for initialization purposes. The PlayingActivity serves as the main source of information
	 * for the robot about the current position, the presence of walls, the reaching of an exit.
	 * The PlayingActivity is assumed to be in the playing state.
	 * @param act is the communication partner for robot
	 * @throws IllegalArgumentException if PlayingActivity is null,
	 * or if PlayingActivity is not in playing state,
	 * or if PlayingActivity does not have a maze
	 */
	void setPlayingActivity(PlayingActivity act);
