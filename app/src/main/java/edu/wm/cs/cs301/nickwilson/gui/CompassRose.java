...
public class CompassRose {
    ...
    private static final int CIRCLE_SHADE = Color.argb(1.0f, 1.0f, 1.0f, 0.3f);
...
//    private final Font markerFont;
     ...
     * one in JComponent.
     * @param panel The graphics object to draw on, actually must be a MazePanel object.
     */
    public void paintComponent(MazePanel panel) {
        
        //final MazePanel panel2 = panel;
        /* Original code
